...
public class KakaoAuthBO {
	private final static String KAKAO_CLIENT_ID = "";
	private final static String KAKAO_CLIENT_SECRET = "";
	private final static String KAKAO_REDIRECT_URI = "/member/kakao_callback";		
	...
	public String getAuthorizationUrl(HttpSession session, String serverUrl) {
		...
		OAuth20Service oauthService = new ServiceBuilder()
				...
				.callback(serverUrl + KAKAO_REDIRECT_URI).state(state).build(KakaoLoginApi.instance());
	...
	public String getUserProfile(OAuth2AccessToken oauthToken, String serverUrl) throws Exception {
		OAuth20Service oauthService = new ServiceBuilder()
				.apiKey(KAKAO_CLIENT_ID).apiSecret(KAKAO_CLIENT_SECRET)
				.callback(serverUrl + KAKAO_REDIRECT_URI).build(KakaoLoginApi.instance());
