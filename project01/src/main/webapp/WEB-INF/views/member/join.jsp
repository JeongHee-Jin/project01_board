...
<!-- 	            <div class="join_In int-area">
	            ...
	            <div class="join_In int-area">
	             ...
	             <div class="join_In int-area">
	            	<input type="text" name="phoneNum" id="phoneNum" autocomplete="off" maxlength="11"
	            	oninput="this.value = this.value.replace(/[^0-9\-]/gi,'');" >
	            	<label for="phon"class="phon_label" >휴대번호(선택)</label>
	            	<div id="phon_regul" class="regul_div"></div>
	            </div>
	            <div class="join_In int-area">
