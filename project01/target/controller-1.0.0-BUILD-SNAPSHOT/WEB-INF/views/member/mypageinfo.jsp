...
<body onload="infoFunction()">
	<div id="mypageInfo_container">
		<div id="mypageInfo_area">		
				...
				<dl class="my_dl box">
					...
					<dd id="addr_modify"class="modifyEnter" >
						<div>
	            			...
	            			<button type="button" class="btn_postcode" onclick="postCode();" style="height:40px;float:right;">우편번호검색</button>
			...
			<div class="mypageInfo_bottom">
<!-- 				<button class="cancle info_btn" >취소</button>
				<button id="info_update" class="info_btn update" >수정</button>		 -->		
			</div>
		</div>			
	</div>
</body>
